    ...
    <main className='block min-h-screen'>
      <section className='h-screen flex justify-center align-middle'>
        <div className='w-3/6'>
          ...
          <img className='absolute blur-sm -z-40 lg:blur-none w-96 mt-16 ml-48' src="./Features/iphone-13-Pro-Front.png" />
      ...
      <section className='flex align-middle'>
        ...
        <div>
          ...
          <img className='absolute blur-sm -z-40 lg:blur-none right-0 w-96 mt-20 mr-24' src="./Features/iPhone-13-Pro-Front (1).png" alt="" />
          <img className='absolute blur-sm -z-40 lg:blur-none right-0 mt-72 mr-28 h-32' src="./Features/On Hold.png" alt="" />
        </div>
      </section>
      <section className='flex h-screen'>
        ...
        <div className='w-3/6 flex flex-col justify-center align-middle'>
          ...
          <img className='absolute blur-sm -z-40 lg:blur-none w-96 mt-32 ml-48' src="./Features/iPhone-13-Pro-Front (2).png" alt="" />
          <img className='absolute blur-sm -z-40 lg:blur-none -mt-16 ml-64 h-32' src="./Features/Group (1).png" alt="" />
        </div>
