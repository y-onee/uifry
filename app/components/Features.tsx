    ...
    <main className='block min-h-screen font-clash-display-bold'>
      <section className='h-screen flex justify-center align-middle'>
        <div className='w-3/6'>
          ...
          <img className='absolute hover:scale-110 transform transition-all delay-75 blur-sm lg:z-0 -z-40 lg:blur-none w-96 mt-16 ml-48' src="./Features/iphone-13-Pro-Front.png" />
