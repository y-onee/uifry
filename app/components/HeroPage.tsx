        ...
        <nav className="w-100 flex items-center align-middle justify-center py-5 backdrop-blur-sm">
          <section className=" w-5/6 h-[60px] p-6 flex items-center justify-between">
            ...
            <div className="flex w-1/2 justify-between">
              ...
              <div className={`lg:flex hidden justify-evenly flex-row items-center w-4/5 font-clash-display-medium`}>
                <a href="" className="hover:text-[#FF5555] hover:font-clash-display-semibold">Home</a>
                <a href="" className="hover:text-[#FF5555] hover:font-clash-display-semibold">About Us</a>
                <a href="" className="hover:text-[#FF5555] hover:font-clash-display-semibold">Pricing</a>
                <a href="" className="hover:text-[#FF5555] hover:font-clash-display-semibold">Features</a>
              </div>
            ...
            <button className="hidden lg:block bg-black text-white p-3 px-7 rounded font-medium hover:border-2 hover:bg-white hover:text-black font-clash-display-medium">Download</button>
          </section>

        </nav>
        <div className='flex justify-center'>
          <div className={`flex text-white bg-black/90 backdrop-blur-sm h-72 rounded border-2 align-middle justify-evenly flex-col items-center w-4/5 font-clash-display-medium ${isVisible ? `block` : `hidden`}`}>
      ...
      <section className='flex justify-start align-middle ml-20'>
        <div className='lg:w-3/5 mt-[80px] lg:bg-transparent sm:px-20'>
          ...
          <div className='flex'>
            ...
            <button className="mx-2 hover:border-2 flex justify-center align-middle p-3 px-7 rounded font-medium font-clash-display-medium"><img className='mr-3' src="./Group 3.png" alt="" /><p className='my-1'>Watch Video</p></button>
          </div>
        ...
        <div>
          ...
          <img className='absolute left-0 mt-96 pt-40 ml-72' src="./Star 8.png" alt="" />
        </div>
      </section>
    </main >
