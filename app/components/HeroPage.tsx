        ...
        <nav className="w-100 flex items-center align-middle justify-center py-5 backdrop-blur-sm">
          <section className=" w-5/6 h-[60px] p-6 flex items-center justify-between">
            ...
            <div className="flex w-1/2 justify-between">
              ...
              <div className={`lg:flex  justify-evenly items-center w-4/5 ${isVisible ? `block` : `hidden`}`}>
            ...
            <button className="hidden lg:block bg-black text-white p-3 px-7 rounded font-medium">Download</button>
          </section>
        </nav>
      </section>
      <section className='flex justify-start align-middle lg:ml-40 mx-20'>
        <div className='lg:w-3/5 mt-[80px] bg-gray-200/20 lg:bg-transparent sm:px-20'>
          <div>
        ...
        <div className=''>
          ...
          <img src="./iPhone-13-Pro-Front (1).png" alt="" className='absolute blur-sm -z-40 lg:blur-none top-40 right-16 h-[600px]' />
          <img src="./iPhone-13-Pro-Front (2).png" alt="" className='absolute blur-sm -z-40 lg:blur-none top-28 right-40 h-[600px]' />
          <img src="./iPhone-13-Pro-Front (1).png" alt="" className='absolute blur-sm -z-40 lg:blur-none top-12 right-64 h-[600px]' />
        </div>
        <div>
